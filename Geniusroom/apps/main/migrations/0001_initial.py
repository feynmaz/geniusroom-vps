...
import Geniusroom.apps.main.utilities
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heroes', models.TextField(verbose_name='Упоминаются')),
                ('image', models.ImageField(blank=True, upload_to=Geniusroom.apps.main.utilities.get_timestamp_path, verbose_name='Основная иллюстрация')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=Geniusroom.apps.main.utilities.get_timestamp_path, verbose_name='Изображение')),
        ...
        migrations.AddField(
            model_name='article',
            name='rubric',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main.subrubric', verbose_name='Подрубрика'),
        ),
    ]
